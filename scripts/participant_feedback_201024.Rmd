...
sleep_data <- data.frame(
  Name = c("Sleep Latency", "Total Sleep Time", "Sleep Efficiency", "Total Time in Bed", 
           "Apnoea per hour"),
  Description = c("Time to transition from full wakefulness to sleep", 
                  "Total duration of sleep during the PSG", 
                  "Ratio of total sleep time to the total time spent in bed", 
                  "Total time spent in bed during the PSG", 
...
Sleep is divided into stages based on the types of electical activity in the brain, eye movement and muscle tone.  The pictures below show examples of your brain, eye movement and muscle tone in the different sleep stages.  
<br>
<br>
...
participant_n1 <- paste0("Z:/Polysomnography/Data/", studyID, "/", studyID,"_n1.pdf")
...
# Define the PDF file
# define participant folder that contains sleep stage images
participant_n2 <- paste0("Z:/Polysomnography/Data/", studyID, "/", studyID,"_n2.pdf")
...
# define participant folder that contains sleep stage images
participant_n3 <- paste0("Z:/Polysomnography/Data/", studyID, "/", studyID,"_n3.pdf")
...
# define participant folder that contains sleep stage images
participant_rem <- paste0("Z:/Polysomnography/Data/", studyID, "/", studyID,"_rem.pdf")
...
# define participant folder that contains sleep stage images
participant_wake <- paste0("Z:/Polysomnography/Data/", studyID, "/", studyID,"_wake.pdf")
...
# Create the SQL query to retrieve data for the given studyID
ques_query <- paste0("SELECT Chronotype, isi_cat, SB_cat, isi_total, meq_total, SB_total FROM FinalScores WHERE studyID = '", studyID, "'")
...
##   3. Axivity Data   
The Axivity watch records data about wrist movement that is used to estimate the duration and quality of your sleep over the study duration.  Summaries of the output for each day of data are shown in the next two pages.
...
directory <- paste0(base_directory, studyID, "/results/file summary reports/")

# List all files in the directory
all_files <- list.files(directory, full.names = TRUE)

# Search for files that contain "stydyID" anywhere in the filename and have a ".pdf" extension
pdf_file <- grep(paste0(studyID, ".*\\.pdf$"), all_files, value = TRUE)
